    ...
    <div className="bg-gray-900 text-white min-h-screen flex flex-col items-center justify-center p-8">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-lg md:text-xl">
          Aquí puedes explorar más sobre mí, mi educación, proyectos y habilidades. ¡Disfruta navegando!
        </p>
      </div>
      ...
      <div className="relative w-full max-w-xs md:max-w-sm mb-8">
        ...
        />
        {/* Efecto de overlay */}
        <div className="absolute inset-0 bg-gradient-to-t from-gray-900 via-transparent to-transparent rounded-lg opacity-60"></div>
      </div>
