...
const Proyectos = () => {
  ...
  return (
      ...
      <div className="bg-gray-900 text-white min-h-screen py-8">
        ...
        <section
          ref={sectionRef}
          className="flex justify-center mx-auto px-4 sm:px-6 lg:px-16 py-8"
        >
          <motion.div
          ...
          >
            {[
              ...
              <motion.div
                key={index}
                className="bg-gray-800 rounded-lg shadow-lg overflow-hidden border-2 border-gray-700 transition-transform transform hover:scale-105 hover:bg-gray-700 duration-300 group"
                variants={fadeInLeft}
                initial="hidden"
                animate={inView ? "visible" : "hidden"}
                transition={{ duration: 0.8, delay: 0.2 * index }}
              >
                <div className="relative h-48 w-full overflow-hidden group-hover:scale-110 transition-transform duration-500">
                  <Image
